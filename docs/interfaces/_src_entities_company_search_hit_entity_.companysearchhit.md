...
*Defined in [src/entities/company-search-hit.entity.ts:5](https://github.com/twolionsco/linkedin-private-api/blob/6efeb13/src/entities/company-search-hit.entity.ts#L5)*
