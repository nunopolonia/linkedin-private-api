...
*Defined in [src/entities/linkedin-message-event.entity.ts:6](https://github.com/twolionsco/linkedin-private-api/blob/a05191c/src/entities/linkedin-message-event.entity.ts#L6)*
...
*Defined in [src/entities/linkedin-message-event.entity.ts:7](https://github.com/twolionsco/linkedin-private-api/blob/a05191c/src/entities/linkedin-message-event.entity.ts#L7)*
...
*Defined in [src/entities/message-event.entity.ts:6](https://github.com/twolionsco/linkedin-private-api/blob/a05191c/src/entities/message-event.entity.ts#L6)*
...
*Defined in [src/entities/message-event.entity.ts:5](https://github.com/twolionsco/linkedin-private-api/blob/a05191c/src/entities/message-event.entity.ts#L5)*
